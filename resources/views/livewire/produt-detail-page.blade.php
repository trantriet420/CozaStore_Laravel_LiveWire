          ...
          <div class="sticky top-0 z-50 overflow-hidden ">
            ...
            <div class="flex-wrap hidden md:flex ">
                @foreach ($product->images as $productImg)
                    <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{url('storage', $productImg)}}'">
                        <img src="{{url('storage', $productImg)}}" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                    </div>
                @endforeach
